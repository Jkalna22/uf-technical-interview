...
const PieChart = ({allDriverData}) => {
    ...
    const injuryStats = allDriverData.map((driver) => {
        if(driver.injury_severity === "None") {
            ...
            injurySeverityData[2]["Serious Injury"] = injurySeverityData[2]["Serious Injury"] + 1;
    ...
    console.log(injurySeverityData);
        ...
        datasets: [
          {
            ...
            data: [injurySeverityData[3]["Fatal"], injurySeverityData[1]["Injury"], injurySeverityData[0]["None"], injurySeverityData[2]["Serious Injury"]],
            backgroundColor: [
              'rgba(199, 0, 0, 1)',
              'rgba(240, 208, 0, 1)',
              'rgba(0, 199, 0, 1)',
