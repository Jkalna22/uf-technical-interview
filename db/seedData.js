...
async function populateCrashEventData() {
  ...
  try {
    const crashData = [
      {
        reportNumber: 5000001,
        crashDate: "2021/05/01",
        crashTime: "11:12:00",
        county: "Alachua",
        city: "Gainesville",
        investigatingAgency: "Gainesville Police Department",
        onStreet: "NW 14th Street",
        offsetFeet: null,
        offsetDirection: null,
        fromIntersectingStreet: "NW 2nd Avenue",
        crashSeverity: "Property Damage Only",
        latitude: 29.65336,
        longitude: -82.340477,
      },
      {
        reportNumber: 5000002,
        crashDate: "2021/05/01",
        crashTime: "15:58:00",
        county: "Alachua",
        city: "Gainesville",
        investigatingAgency: "Florida Highway Patrol",
        onStreet: "SR-24",
        offsetFeet: null,
        offsetDirection: null,
        fromIntersectingStreet: "SW 34th Street",
        crashSeverity: "Serious Injury",
        latitude: 29.627061,
        longitude: -82.372452,
      },
      {
        ...
        city: "Gainesville",
        investigatingAgency: "Gainesville Police Department",
        onStreet: "SW 34th Street",
        offsetFeet: 150,
        offsetDirection: "North",
        fromIntersectingStreet: "SW Archer Road",
        crashSeverity: "Injury",
        latitude: 29.627653,
        longitude: -82.37244,
      },
      {
        reportNumber: 5000004,
        crashDate: "2021/05/01",
        crashTime: "17:15:00",
        county: "Alachua",
        city: "Unincorporated",
        ...
        offsetFeet: 3000,
        offsetDirection: "North",
        fromIntersectingStreet: "SR-24",
        crashSeverity: "Fatal",
        latitude: 29.623165,
        longitude: -82.390096,
      },
      {
        reportNumber: 5000005,
        crashDate: "2021/05/01",
        crashTime: "18:11:00",
        county: "Alachua",
        city: "Unincorporated",
        investigatingAgency: "Alachua County Sheriff's Office",
        onStreet: "3970 SW Archer Road (Parking Lot)",
        offsetFeet: null,
        offsetDirection: null,
        fromIntersectingStreet: null,
        crashSeverity: "Property Damage Only",
        latitude: 29.620315,
        longitude: -82.384064,
      },
    ...
    const vehicleData = [
      {
        ...
        model: "ACCORD",
        color: "WHT",
        travelingOnStreet: "NW 14th Street",
        travelingDirection: "North",
      ...
      },
      {
        ...
        model: "MODEL S",
        color: "RED",
        travelingOnStreet: "NW 2nd Avenue",
        travelingDirection: "West",
      ...
      },
      {
        ...
        model: "FIREBIRD",
        color: "WHT",
        travelingOnStreet: "SR-24",
        travelingDirection: "East",
        maneuver: "Turning Left",
      },
      {
        reportNumber: 5000002,
      ...
      },
      {
        ...
        model: "EXPEDITION",
        color: "BLK",
        travelingOnStreet: "SW 34th Street",
        travelingDirection: "North",
        maneuver: "Straight Ahead",
      },
      {
      ...
      },
      {
        ...
        model: "CHEROKEE",
        color: "BLK",
        travelingOnStreet: "Target Parking Lot",
        travelingDirection: "East",
        maneuver: "Backing",
      },
      {
        ...
        color: "WHT",
        travelingOnStreet: "Target Parking Lot",
        travelingDirection: "South",
        maneuver: "Straight Ahead",
      },
    ];

    const vehicleCrashEventData = await Promise.all(
      vehicleData.map(createVehicleCrashEventData)
    );
  ...
  try {
    const driverData = [
      ...
      },
      {
        ...
        sex: "F",
        age: 56,
        restraintSystems: "Lap Belt Only",
      },
      {
        reportNumber: 5000002,
        vehicleNumber: 2,
        personNumber: 2,
        injurySeverity: "Serious Injury",
        sex: "M",
        age: 68,
        restraintSystems: "None Used",
      },
      {
        reportNumber: 5000003,
        vehicleNumber: 1,
    ...
    const driverCrashEventData = await Promise.all(
      driverData.map(createDriverCrashEventData)
    );
